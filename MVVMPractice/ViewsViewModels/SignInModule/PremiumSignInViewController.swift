...
class PremiumSignInViewController: UIViewController {
    
    @IBOutlet private weak var emailTextField: ImageTextField!
    @IBOutlet private weak var passwordTextField: ImageTextField!
    
    @IBOutlet private weak var signInButton: UIButton! {
        didSet {
            signInButton.style.round().orangeWhite().localized(text: "Sign In")
        }
    }
